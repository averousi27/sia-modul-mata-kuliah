...
<html>
    <head>
		...
		<title>Kelola Capaian Pembelajaran Mata Kuliah</title>
	</head>
				...
				<div class="row" id="master-detail" style="display:none;">
					<div class="container">
						<div class="col-md-6" style="margin-bottom:10px;">
							<h4 id="title">Capaian Belajar untuk Mata Kuliah</h4>
							<form:form role="form" commandName="capPembMK" class="formdetail">  
								...
								<div class="form-group">
									<label>Nama Capaian Belajar MK</label>
								...
								<div class="form-group">
									<label>Deskripsi Capaian Belajar MK</label>
