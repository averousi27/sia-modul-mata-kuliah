		...
		<script>
			...
			$(".delete").click(function(){
			   var thnAjaran = $(".form-master").serialize();
				...
				$.ajax( {
	                "dataType": 'json',
	                "type": "POST",
	                "url": context_path+"tahunajaran/deletemany",
	                "data": thnAjaran,
				   ...
				   submitHandler: function() { 
					   var thnAjaran = $("#thnAjaran").serialize();
						...
						$.ajax( {
			                "dataType": 'json',
			                "type": "POST",
			                "url": context_path+"tahunajaran/simpan",
			                "data": thnAjaran,
			                "success": function(data){
			                	if(data.status =="ok") 
		                		{
			...
			var deleteData = function(id)
			{
				...
				$.ajax( {
	                "dataType": 'json',
	                "type": "POST",
	                "url": context_path+"tahunajaran/delete",
	                "data": tempData,
	                "success": function(data){
	                	unblockUI($("#masterpage"))
	                	if(data.status =="ok") 
			...
			var edit = function(id)
			{
				...
				$.ajax( {
	                "dataType": 'json',
	                "type": "POST",
	                "url": context_path+"tahunajaran/edit",
	                "data": tempData,
	                "success": function(data){
	                	unblockUI($("#master-detail"));
			...
			$('.datatable').dataTable({
		        ...
		        "bServerSide": true,
		        "order": [[1,"desc"]],
		        "sAjaxSource": context_path + "tahunajaran/json",
