		...
		<div class="row" id="master-detail" style="display:none;">
			<div class="container">
				<div class="col-md-6" style="margin-bottom:10px;">
					...
					<form:form role="form" action="login" commandName="thnAjaran" class="formdetail">
						<div class="form-group">
							<label>Tahun</label>
		...
		<script>
			$(document).ready(function(){
				$('#masterpage').masterPage(
				{
					...
					dataUrl: context_path+'tahunajaran/json',
					detailUrl: context_path+'tahunajaran/edit',
					addUrl: context_path+'tahunajaran/simpan',
					editUrl: context_path+'tahunajaran/simpan',
					deleteUrl: context_path+'tahunajaran/deletemany',
					...
					validationRules: {idThnAjaran:{required: false},thnThnAjaran:{required: true,digits:true},persenMinimPertemuan:{required: true},persenHadirMinimPd:{required: true}},
					filters: [{id:'#filter', name:'a_thn_ajaran_terhapus'}]
				});
			});
		</script>
