				...
				<div class="row" id="master-detail" style="display:none;">
					<div class="container">
						<div class="col-md-6" style="margin-bottom:10px;">
							<h4 id="title">Capaian Pembelajaran Satuan Manajemen</h4>
							<form:form role="form" action="login" commandName="satuanmanajemen" class="formdetail">
								<div class="form-group">
									<label>Tahun Kurikulum</label>
									<form:input path="idKurikulum" name="idKurikulum" class="form-control" value="${kurikulum.thnAwal} - ${kurikulum.nmKurikulum}" disabled="true"/> 
								</div>
								<div class="form-group">
									<label>Nama Satuan Manajemen</label>
									<form:input path="idSatMan" name="idSatMan" class="form-control" value="${satman.nmSatMan}" disabled="true"/> 
								</div> 
								<div class="form-group">
									<label>Nama Capaian Pembelajaran</label>
									<form:input path="nmCapPemb" class="form-control" placeholder="Berisi nama capaian pembelajaran" required="true" />
									<form:hidden path="idCapPemb" class="form-control" />
								</div> 
								<div class="form-group">
									<label>Deskripsi Capaian Pembelajaran</label>
									<form:input path="deskripsiCapPemb" class="form-control" placeholder="Berisi deskripsi capaian pembelajaran" required="false"/>
								</div> 
				...
				<script>
					$(document).ready(function(){
						$('#masterpage').masterPage(
						{
							...
							dataUrl: context_path+'/capaianbelajar/satman/json',
							detailUrl: context_path+'/capaianbelajar/satman/edit',
							addUrl: context_path+'/capaianbelajar/satman/simpan',
							editUrl: context_path+'/capaianbelajar/satman/simpan',
							deleteUrl: context_path+'/capaianbelajar/satman/deletemany',
