			...
			<script src="${pageContext.servletContext.contextPath}/resources/js/jquery.masterpage.sia.js" type="text/javascript" ></script>
				...
				<div class="row" id="master-detail" style="display:none;">
					<div class="container">
						<div class="col-md-6" style="margin-bottom:10px;">
							<h4 id="title">Ekuivalensi/Penyetaraan Mata Kuliah</h4>
							<form:form role="form" action="login" commandName="ekuivalensiMK" class="formdetail"> 
								<div class="form-group">
									<label>Kode dan Nama Mata Kuliah Utama</label>
								...
								<div class="form-group">
									<label>Kode dan Nama Mata Kuliah Ekuivalensi</label>
									<select id="mkIdMK" name="mkIdMK" class="form-control">
											<option value="">Pilih kode dan nama mata kuliah ekuivalensi/penyetaraan</option> 
										<c:forEach items="${mkList}" var="mk"> 
											<option value="${mk.idMK}">${mk.kodeMK} - ${mk.namaMK}</option>
										</c:forEach>  
									<select>
				...
				<script>
					$(document).ready(function(){
						...
						{
							detailFocusId: '#idEkuivalensiMK',
							dataUrl: context_path+'matakuliah/ekuivalensi/json',
							detailUrl: context_path+'matakuliah/ekuivalensi/edit',
							addUrl: context_path+'matakuliah/ekuivalensi/simpan',
							editUrl: context_path+'matakuliah/ekuivalensi/simpan',
							deleteUrl: context_path+'matakuliah/ekuivalensi/deletemany',
							primaryKey: 'idEkuivalensiMK',
					        order: [[1,"asc"]],
							editOnClick: false,
							editOnClickRow: true,
							cols: [
								...
								{ 
									...
									mRender: function(data,type,full){
										return '<div class="checkbox-data"><input type="checkbox" name="idEkuivalensiMK[]" value="'+data+'"></div>';
									}
								},
								/* kode mata kuliah */
								{ "bVisible":    true }, 
